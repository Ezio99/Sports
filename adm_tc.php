...
if(mysqli_num_rows($recs)!=NULL)
{
    ...
    {
        echo"<tr><td>$i</td><td>$rec[0]</td><td>$rec[1]</td><td>$rec[3]</td><td><form method=\"POST\" action=\"adm_tc_det.php\"> <input type=\"hidden\" name=\"tcid\" value=\"$rec[0]\"> <input name=\"choice\" type=\"submit\" value=\"Details\">  <input name=\"choice\"  type=\"submit\" value=\"Delete\"></form></td></tr>";
        $i++;
    }
    echo"</table>";
}
